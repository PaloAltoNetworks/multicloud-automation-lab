...
module "web" {
	...
	web_ip 					= "10.5.2.5"
	web_image				= "https://www.googleapis.com/compute/v1/projects/ignite19-multicloud-automation/global/images/web-1557198621"
}
...
module "db" {
	...
	db_ip 					= "10.5.3.5"
	db_image				= "https://www.googleapis.com/compute/v1/projects/ignite19-multicloud-automation/global/images/db-1557200292"
}
